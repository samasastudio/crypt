...
- [Original master spec](../../../Basilisk%20SH%20Master%20Spec.md)
...
- Working on app structure or engine boundaries: [Architecture](implementation/architecture.md)
- Working on types and canonical models: [Data model](implementation/data-model.md)
- Working on UI, performance, or authoring formats: [UX, performance, and content pipeline](implementation/ux-performance-and-content.md)
- Working on milestones, MVP boundaries, or rollout sequencing: [Roadmap](planning/roadmap.md)
- Working on implementation concerns that are still unsettled: [Risks and open questions](planning/risks-and-open-questions.md)
